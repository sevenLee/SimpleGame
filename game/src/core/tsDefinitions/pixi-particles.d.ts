// Typings for pixi-particles 2.1.6, requires Pixi.js typings
declare namespace PIXI.particles {
	...
	export class Emitter {
		...
		public startAlphaVariance:number;
		public endAlpha:number;
		public endAlphaVariance:number;
		public speed:number;
